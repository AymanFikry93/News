...
import com.android.ayman.news.Adapters.NewsAdapter;
import com.android.ayman.news.Classes.NewsClass;
import com.android.ayman.news.UI.RecyclerItemClickListener;
...
//                        Toast.makeText(MainActivity.this,"Resturants are Refreshed.", Toast.LENGTH_SHORT).show();
        ...
        ArrayList<NewsClass> classnewssList=null;

        recyclerresturantView = (RecyclerView) findViewById(R.id.news_recycler_view);
        ...
        NewsAdapter newsadapter = new NewsAdapter(getApplicationContext(),classnewssList);

        recyclerresturantView.setAdapter(newsadapter);
